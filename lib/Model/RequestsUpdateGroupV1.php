...
/**
 * RequestsUpdateGroupV1 Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestsUpdateGroupV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'requests.UpdateGroupV1';
     ...
     *
     * @param string|null $assignment_rule The new assignment rule of the group. Note: If the group type is static, this field cannot be updated manually
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The new name of the group
     *
     * @return self
     */
