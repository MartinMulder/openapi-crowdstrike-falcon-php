...
/**
 * MsaAggregateQueryRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MsaAggregateQueryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'msa.AggregateQueryRequest';
    ...
    protected static $openAPITypes = [
        'date_ranges' => '\OpenAPI\Client\Model\MsaDateRangeSpec[]',
        'field' => 'string',
        'filter' => 'string',
        'interval' => 'string',
        'min_doc_count' => 'int',
        ...
        'name' => 'string',
        'q' => 'string',
        'ranges' => '\OpenAPI\Client\Model\MsaRangeSpec[]',
        'size' => 'int',
        'sort' => 'string',
        'sub_aggregates' => '\OpenAPI\Client\Model\MsaAggregateQueryRequest[]',
        'time_zone' => 'string',
        'type' => 'string'
    ];
     ...
     * Gets date_ranges
     *
     * @return \OpenAPI\Client\Model\MsaDateRangeSpec[]
     */
     ...
     * Sets date_ranges
     *
     * @param \OpenAPI\Client\Model\MsaDateRangeSpec[] $date_ranges date_ranges
     *
     * @return self
     */
     ...
     * Gets ranges
     *
     * @return \OpenAPI\Client\Model\MsaRangeSpec[]
     */
     ...
     * Sets ranges
     *
     * @param \OpenAPI\Client\Model\MsaRangeSpec[] $ranges ranges
     *
     * @return self
     */
     ...
     * Gets sub_aggregates
     *
     * @return \OpenAPI\Client\Model\MsaAggregateQueryRequest[]
     */
     ...
     * Sets sub_aggregates
     *
     * @param \OpenAPI\Client\Model\MsaAggregateQueryRequest[] $sub_aggregates sub_aggregates
     *
     * @return self
     */
