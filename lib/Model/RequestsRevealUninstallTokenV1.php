...
/**
 * RequestsRevealUninstallTokenV1 Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestsRevealUninstallTokenV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'requests.RevealUninstallTokenV1';
    ...
    {
        $this->container['audit_message'] = $data['audit_message'] ?? null;
     ...
     * Sets audit_message
     *
     * @param string|null $audit_message An optional message to append to the recorded audit log
     *
     * @return self
     */
     ...
     * Sets device_id
     *
     * @param string $device_id The id of the device to reveal the token for
     *
     * @return self
     */
