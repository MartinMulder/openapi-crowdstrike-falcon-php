...
/**
 * FwmgrFirewallFlags Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FwmgrFirewallFlags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'fwmgr.firewall.Flags';
    ...
    {
        $this->container['audit'] = $data['audit'] ?? null;
